          ...
          {user ? (
            ...
            <div className="flex items-center gap-1.5">
              <button
                ...
                className="flex items-center gap-1 px-2.5 py-1.5 rounded-full bg-zinc-900 hover:bg-zinc-800 text-zinc-300 border border-zinc-700/80 text-xs font-semibold shadow-sm transition-all tap-bounce"
              >
