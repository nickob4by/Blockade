  ...
  return (
    <div className="w-full max-w-[400px] mx-auto px-1 py-1 pb-safe space-y-1.5">
      ...
      {selectedWall && isMyTurn ? (
        ...
        <div
          className={`flex items-center justify-between gap-2 p-1.5 rounded-xl bg-zinc-900 border shadow-lg animate-fadeIn ${
        ...
        >
          <button
            ...
            className="flex-1 py-2 px-2.5 rounded-lg bg-zinc-800 hover:bg-zinc-700 text-zinc-300 font-bold text-xs flex items-center justify-center gap-1 tap-bounce border border-zinc-700"
          >
          ...
          >
            <RefreshCw className={`w-3.5 h-3.5 animate-spin-reverse ${isP1 ? 'text-blue-400' : 'text-rose-400'}`} />
        ...
        <div className="flex items-center justify-between px-2.5 py-1.5 rounded-xl bg-zinc-900/60 border border-zinc-800/80 text-xs text-zinc-400">
          ...
          <div className="flex items-center gap-1">
            <button
              type="button"
              onClick={onOpenRules}
              className="p-1.5 rounded-lg bg-zinc-800 hover:bg-zinc-700 text-zinc-300 border border-zinc-700/60 tap-bounce"
              title="Game Rules"
            >
